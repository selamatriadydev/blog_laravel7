    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <a href="{{ url('admin/menus/create') }}" class="btn btn-primary"> <i class="fa fa-plus"></i>Add</a>
                <a href="{{ url('admin/menus') }}" class="btn btn-info"> <i class="fa fa-eye"></i>All</a>
                <a href="{{ url('admin/menus/parent') }}" class="btn btn-info"> <i class="fa fa-eye"></i>Parent</a>
            </div>
            <div class="card-body">
            <table class="table">
                <thead>
